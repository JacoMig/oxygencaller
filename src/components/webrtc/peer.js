...
if (mLine.iceTransport) {
    ...
    {
        console.log("PERR UNRECOGNIZED MESSAGE: ", message)
    }
};
...
this.parent.emit('peerClosed', this);
};
...
console.log("handleRemoteStreamAdded 1")
...
console.log("handleRemoteStreamAdded 2: ", event.stream)
